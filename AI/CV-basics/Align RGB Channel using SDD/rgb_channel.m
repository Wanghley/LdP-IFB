...
% 
% ref_img_region = imcrop(G,[174,145,50,50]);
% 
% ref_img_region = double(ref_img_region);
% 
% RssdImg = double(imcrop(R,[174,145,50,50]));
% 
% BssdImg = double(imcrop(B,[174,145,50,50]));
% 
% RssdImg = circshift(RssdImg,[5,-1]);
% 
% BssdImg = circshift(BssdImg,[0,-1]);
% 
% 
% shiftr = circshift(R,[5,-1]);
% 
% shiftb = circshift(B,[-5,-1]);
% 
% ColorImg_aligned = cat(3,shiftr,G,shiftb);
% 
% imshow(ColorImg_aligned)
