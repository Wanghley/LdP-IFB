...
public class Devolver extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Código de Empréstimo:");
        ...
        if(codExists) {
        	...
        	if(podeDevolverSemMulta) {
        		...
        		if(opt==0) {
        			...
        			dev.setbookData();
        			JOptionPane.showMessageDialog(null,"Pagamento não realizado!!\nUSUÁRIO TRAVADO!!",
        	...
        	JOptionPane.showMessageDialog(null,"Código não Encontrado! Empréstimo não realizado!",
